...
### AI Use
#### General policies
* **Philosophy:** This AI use policy was informed by a lab discussion around [two](https://zenodo.org/records/18930036) [preprints](https://zenodo.org/records/18452320) by Ajun Krishnan. His central premise is that you must develop expertise in a topic before using AI to augment your work. This is for two reasons. First, to use AI tools you must be able to verify their outputs. This requires that you can already do the task, can explain how you did it, and can check and correct errors. Without expertise, you could use AI outputs without understanding that they are wrong. Second, using AI tools before developing expertise skips over necessary training. You can use AI tools to be more productive, but using them to skip the struggle of learning will cause you to become dependent on them.
* **General policy:** AI tools may be used for some tasks in our lab with caution. All outputs must be verified. You are accountable for all the outputs that you use in your work.
* **Privacy:** AI tools often keep copies of everything you share with them, including files, therefore we never give AI tools access to raw data. AI tools use this to train their models, which are available to everyone, so when sharing anything with LLMs, first ask whether you’d be comfortable sharing that information with everyone, including all other scientists working on this topic.
* **Prompts:** AI responses are only as good as your prompts. Use the process of writing a prompt to think through the problem you’re trying to solve. For instance, generate line-by-line pseudocode for a code snippet you’re writing or a detailed outline of questions you need to answer via literature search. Consider whether your prompt is appropriate for the scope of an LLM. For instance, an LLM can’t synthesize an opinion about the scientific literature, but it could find you papers that support or don’t support a claim. LLMs tend towards confirmation bias, supporting the opinion in the prompt. Ask LLMs to explicitly give you both sides of an argument (evidence supporting and against, positive and negative feedback) to counteract this.
* **Documentation:** Discuss how you use LLMs in your research and training with Emily.

#### Specific use cases

* **Code:** AI can be used to assist in writing code (e.g. Github Copilot) if the outputs are thoroughly tested, as you would for any manually generated code. Manually confirm that each step does what you intended. AI cannot be used to write large amounts of code independently (”vibe coding”), as it will likely contain critical errors. Similarly, AI cannot be used to generate whole analysis (e.g. “compare these two groups”). All code must be well formatted and documented. If you use AI tools in writing code, cite the LLM model and version in the header documentation. Copy each sentence of your prompt as comments above each line of the code that it generated.
...
* **Writing:** AI may be used to suggest minor edits, like reducing word counts or simplifying language. AI may never be used for original writing, including papers, presentations, applications, and reviews, as these should be in your own words. Think refinement, not creation. AI should never be your only source of feedback on writing; seek feedback from Emily, lab members, and your mentor network. If you use LLMs in writing, document the prompts, model, and version. We may need state this use in the final publication.
* **Generating practice questions:** AI can be used to generate practice questions as you’re learning a topic, e.g. learning how to code or preparing for an interview or qualifying exam. As with written feedback, it shouldn’t be your only source of practice.
